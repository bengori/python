...
на реальных данных (создать экземпляры класса Position, передать данные, проверить значения
...
if __name__ == '__main__':
    worker = Worker('Петр', 'Петров', 'менеджер')
    print(worker.position)
    worker_1 = Position('эксперт', 'Иван', 'Иванов', 40000, 5000)
    print(worker_1.position)
    print(worker_1._income['wage'])
    print(worker_1._income['bonus'])
